...
async function run() {
  const result = await ryTs.user.createUser({
    id: 10,
    username: "theUser",
    firstName: "John",
    lastName: "James",
...
async function run() {
  const result = await ryTs.user.createUsersWithListInput([
    {
      id: 10,
      username: "theUser",
      firstName: "John",
...
async function run() {
  const result = await ryTs.user.loginUser({});
...
async function run() {
  const result = await ryTs.user.getUserByName({
...
async function run() {
  const result = await ryTs.user.deleteUser({
