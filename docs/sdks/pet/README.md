...
async function run() {
  const result = await ryTs.pet.addPet({
    id: 10,
    name: "doggie",
    category: {
      id: 1,
...
async function run() {
  const result = await ryTs.pet.findPetsByStatus({});
...
async function run() {
  const result = await ryTs.pet.findPetsByTags({});
...
async function run() {
  const result = await ryTs.pet.getPetById({
    petId: 504151,
  });
...
async function run() {
  const result = await ryTs.pet.deletePet({
    petId: 441876,
  });
...
async function run() {
  const result = await ryTs.pet.uploadFile({
    petId: 565380,
  });
